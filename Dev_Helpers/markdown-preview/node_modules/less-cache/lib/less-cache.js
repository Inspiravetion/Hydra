(function() {
  var LessCache, Parser, basename, cacheVersion, crypto, dirname, extname, fs, join, nodeFs, relative, walkdir, _, _ref,
    __slice = [].slice;
  ...
  module.exports = LessCache = (function() {
    ...
    LessCache.prototype.setImportPaths = function(importPaths) {
      var filesChanged, importedFiles, pathsChanged;
      if (importPaths == null) {
        importPaths = [];
      }
      ...
      fs.makeTreeSync(this.importsCacheDir);
    ...
    LessCache.prototype.observeImportedFilePaths = function(callback) {
      ...
      nodeFs.readFileSync = (function(_this) {
        return function() {
    ...
    LessCache.prototype.readFileSync = function(filePath) {
      var css, digest, imports, less, _ref1;
      less = fs.readFileSync(filePath, 'utf8');
      digest = this.digestForContent(less);
      css = this.getCachedCss(filePath, digest);
      if (css == null) {
        _ref1 = this.parseLess(filePath, less), imports = _ref1.imports, css = _ref1.css;
