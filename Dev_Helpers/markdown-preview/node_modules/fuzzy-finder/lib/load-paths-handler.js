(function() {
  ...
  isIgnored = function(loadedPath) {
    ...
    if (repo != null ? repo.isPathIgnored(loadedPath) : void 0) {
      ...
      if (_.indexOf(ignoredNames, name, true) !== -1) {
        return true;
      }
      if (extension = path.extname(name)) {
        if (_.indexOf(ignoredNames, "*" + extension, true) !== -1) {
          return true;
        }
      }
    }
...
//# sourceMappingURL=/../../../../../../../../..//tmp/atom-build/Atom.app/Contents/Resources/app/node_modules/fuzzy-finder/lib/load-paths-handler.js.map
