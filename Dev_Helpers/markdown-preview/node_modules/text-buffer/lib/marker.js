(function() {
  var Delegator, Emitter, Marker, MarkerPatch, OptionKeys, Point, Range, Serializable, extend, isEqual, omit, pick, size, _ref,
    __slice = [].slice;
  ...
  module.exports = Marker = (function() {
    ...
    Marker.prototype.handleBufferChange = function(patch) {
      var changePrecedesMarkerEnd, changePrecedesMarkerStart, changeSurroundsMarkerEnd, changeSurroundsMarkerStart, columnDelta, markerEnd, markerPatch, markerStart, newMarkerRange, newRange, oldRange, rowDelta, valid;
      ...
      changePrecedesMarkerStart = oldRange.end.isLessThan(markerStart) || (!this.hasTail() && oldRange.end.isLessThanOrEqual(markerStart));
