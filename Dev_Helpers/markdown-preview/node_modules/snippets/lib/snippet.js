(function() {
  ...
  module.exports = Snippet = (function() {
    ...
    Snippet.prototype.extractTabStops = function(bodyTree) {
      ...
      extractTabStops = function(bodyTree) {
        ...
        for (_i = 0, _len = bodyTree.length; _i < _len; _i++) {
          ...
          if (segment.index != null) {
            ...
            _results.push(tabStopsByIndex[index] = new Range(start, [row, column]));
      ...
      this.tabStops = [];
      _ref1 = _.keys(tabStopsByIndex).sort();
...
//# sourceMappingURL=/../../../../../../../../..//tmp/atom-build/Atom.app/Contents/Resources/app/node_modules/snippets/lib/snippet.js.map
